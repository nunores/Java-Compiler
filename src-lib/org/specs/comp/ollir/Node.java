...
public class Node {
    ...
    public Node getSucc1() {
        ...
        if(this.succNodes.size() >= 1) return this.succNodes.get(0);
        else return null;
    }

    public Node getSucc2() {
        if(this.succNodes.size() >= 2) return this.succNodes.get(1);
        else return null;
    }
